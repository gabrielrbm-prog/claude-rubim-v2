...
Reference full template: `/Users/gabrielrubim/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/gabrielrubim/.claude/get-shit-done/templates/state.md`.
